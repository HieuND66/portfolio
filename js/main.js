    ...
    if(event.target.classList.contains("link-item")){
      if(event.target.hash !== ""){
        ...
        if(navMenu.classList.contains("open")){
          ...
          hidenNavMenu();
          // console.log("co link item");
        }else{
          // console.log("ko link item");
 ...
 (() => {
   ...
   tabsContainer.addEventListener("click", (event) => {
     /* if even.target contains 'tab-item'  class and not contains 'active'  class*/
 ...
 (() => {
   ...
   function popupDetails() {
     ...
     const title = portfolioItems[itemIndex].querySelector(".portfolio-item-item-title").innerHTML;
